var booksByYear = {
    ...
    2025: [
        ...
        { title: "Khubilai Khan", author: "John Man", directCover: "https://books.google.com/books/content?id=uV0ikDy7Qm8C&printsec=frontcover&img=1&zoom=1", color: "#556b2f" },
        { title: "King of Diamonds", author: "Rena Pederson", directCover: "https://books.google.com/books/content?id=DJzEEAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#7c3a2e" },
        { title: "The Man Who Solved the Market", author: "Gregory Zuckerman", isbns: ["073521798X", "0735217998"], color: "#92400e" },
        { title: "Mongol Queens", author: "Jack Weatherford", isbns: ["0307407152"], color: "#1e3a5f" },
        { title: "My Life as a Quant", author: "Emanuel Derman", isbns: ["0471394203", "0470192739"], color: "#3d3929" },
        { title: "Odyssey Moscow", author: "Michael Calvey", isbns: ["9781803997308", "1803997303"], directCover: "https://static.wixstatic.com/media/469c6d_7f10e91836f548e199616f569900f5c1~mv2.png/v1/fill/w_248,h_433,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/book-odyssey.png", color: "#6b5c4d" },
        { title: "Reentry", author: "Eric Berger", isbns: ["1637745273"], directCover: "https://benbellabooks.com/wp-content/uploads/2024/04/9781637745274.jpg", color: "#4a5240" },
    ...
    2024: [
        ...
        { title: "All You Need to Know About the Music Business", author: "Donald S. Passman", isbns: ["1668011069", "1501122185"], color: "#8b4513" },
        { title: "The Arc of Boxing", author: "Mike Silver", directCover: "https://books.google.com/books/content?id=Mo0eAwAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#556b2f" },
        { title: "The Art of Short Selling", author: "Kathryn F. Staley", isbns: ["0471146323"], color: "#7c3a2e" },
        { title: "The BFG", author: "Roald Dahl", isbns: ["0142410381", "0141346396"], color: "#92400e" },
        { title: "Boy", author: "Roald Dahl", isbns: ["0142413836", "0140318909"], color: "#1e3a5f" },
        { title: "Broadbandits", author: "Om Malik", isbns: ["0471434051"], color: "#3d3929" },
        { title: "Buy This, Not That", author: "Sam Dogen", isbns: ["0593328779"], color: "#6b5c4d" },
        { title: "Charlie and the Chocolate Factory", author: "Roald Dahl", isbns: ["0142410314", "0141346450"], color: "#4a5240" },
        { title: "Charlie and the Great Glass Elevator", author: "Roald Dahl", isbns: ["0142410322", "0141346469"], color: "#78593a" },
        { title: "Danny the Champion of the World", author: "Roald Dahl", isbns: ["0142410330", "0141346434"], color: "#2f4f4f" },
        { title: "Dear Chairman", author: "Jeff Gramm", isbns: ["0062369830"], color: "#705038" },
        { title: "Diary of a Very Bad Year", author: "n+1 & Keith Gessen", directCover: "https://books.google.com/books/content?id=ImD3vWnW76oC&printsec=frontcover&img=1&zoom=1", color: "#8a7b5e" },
        { title: "Drunk in China", author: "Derek Sandhaus", directCover: "https://books.google.com/books/content?id=tF6vDwAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#5c4033" },
        { title: "Elon Musk", author: "Walter Isaacson", isbns: ["1982181281"], color: "#8b4513" },
        { title: "Focus: The ASML Way", author: "Marc Hijink", directCover: "https://books.google.com/books/content?id=nCABEQAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#556b2f" },
        ...
        { title: "Material World", author: "Ed Conway", directCover: "https://books.google.com/books/content?id=sJCsEAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#2f4f4f" },
        ...
        { title: "Tobacco", author: "Iain Gately", isbns: ["0802139604"], color: "#556b2f" },
        { title: "Trillions", author: "Robin Wigglesworth", isbns: ["0593087682"], color: "#7c3a2e" },
        { title: "Ubiquity", author: "Mark Buchanan", isbns: ["0609809989"], color: "#92400e" },
        { title: "The Whole-Brain Child", author: "Daniel J. Siegel & Tina Payne Bryson", isbns: ["0553386697", "0553807919"], color: "#1e3a5f" }
    ],
    2023: [
        { title: "Anatomy of a Swipe", author: "Ahmed Siddiqui & Nicholas Straight", directCover: "https://books.google.com/books/content?id=HUVrzQEACAAJ&printsec=frontcover&img=1&zoom=1", color: "#5c4033" },
        { title: "Billion Dollar Molecule", author: "Barry Werth", isbns: ["0671510576", "0671723545"], color: "#8b4513" },
        ...
        { title: "Innovation", author: "James Dyson", directCover: "https://books.google.com/books/content?id=s748EAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#3d3929" },
        { title: "Leadership in War", author: "Andrew Roberts", isbns: ["0525522387"], color: "#6b5c4d" },
        { title: "Memoirs of the Second World War", author: "Winston Churchill", directCover: "https://books.google.com/books/content?id=POhDUBY_ESIC&printsec=frontcover&img=1&zoom=1", color: "#4a5240" },
        { title: "More Money Than God", author: "Sebastian Mallaby", isbns: ["0143119419", "1594202559"], color: "#78593a" },
        { title: "The Anxious Investor", author: "Scott Nations", directCover: "https://books.google.com/books/content?id=jiY3EAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#2f4f4f" },
        { title: "The Club", author: "Joshua Robinson & Jonathan Clegg", directCover: "https://books.google.com/books/content?id=cLF5DwAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#705038" },
        { title: "The Greatest Trade Ever", author: "Gregory Zuckerman", isbns: ["0385529945", "0385529910"], color: "#8a7b5e" },
        { title: "The Pay Off", author: "Gottfried Leibbrandt & Natasha de Terán", directCover: "https://books.google.com/books/content?id=vGSTzgEACAAJ&printsec=frontcover&img=1&zoom=1", color: "#5c4033" },
        { title: "The Price of Time", author: "Edward Chancellor", isbns: ["0802160069"], color: "#8b4513" },
        { title: "There's Always Something to Do", author: "Christopher Risso-Gill", directCover: "https://books.google.com/books/content?id=RgkIIBSF1PkC&printsec=frontcover&img=1&zoom=1", color: "#556b2f" },
        { title: "Trillion Dollar Triage", author: "Nick Timiraos", directCover: "https://books.google.com/books/content?id=2Uw6EAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#7c3a2e" },
        { title: "Tubes", author: "Andrew Blum", isbns: ["0061994952", "0061994936"], color: "#92400e" },
        { title: "Two and Twenty", author: "Sachin Khajuria", directCover: "https://books.google.com/books/content?id=nDU_EAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#1e3a5f" },
        { title: "What I Learned About Investing from Darwin", author: "Pulak Prasad", directCover: "https://books.google.com/books/content?id=L7GLEAAAQBAJ&printsec=frontcover&img=1&zoom=1", color: "#3d3929" },
        { title: "The World's Banker", author: "Sebastian Mallaby", isbns: ["0143036793", "1594200157"], color: "#6b5c4d" }
    ]
};
...
function createBookCard(book) {
    ...
    wrapper.style.background = 'linear-gradient(145deg, ' + book.color + ', ' + adjustColor(book.color, 30) + ')';
